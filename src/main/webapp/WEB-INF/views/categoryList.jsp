    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <fieldset class="layui-elem-field">
                <legend>一级类目 - 类目列表</legend>
                <div class="layui-field-box">
                    <form class="layui-form" action="${path}/category/categoryList.do?pageNow=${pageBean.pageNow}">
                        <div class="layui-form-item" style="text-align:center;">
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input autocomplete="off"
                                           class="layui-input" placeholder="请输入类目名称"
                                           type="text" name="keywords" value="${pageBean.keywords}">
                                </div>
                            </div>
                    ...
                    <table class="layui-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <c:set var="i" value="0"/>
                                <c:forEach var="categorySecond" items="${category.categorySecondList}">
                    ...
                    <ul id="menu">
                        <c:if test="${beginPage>10}">
                            <li>
                                <a href="${path}/category/categoryList.do?pageNow=1&keywords=${pageBean.keywords}">首页</a>
                            </li>
                            <li>
                                <a href="${path}/category/categoryList.do?pageNow=${beginPage-10}&keywords=${pageBean.keywords}">上一页</a></li>
                        </c:if>
                        <c:forEach var="i" begin="${beginPage}" end="${endPage}">
                            <li><a href="${path}/category/categoryList.do?pageNow=${i}&keywords=${pageBean.keywords}">${i}</a></li>
                        </c:forEach>
                        ...
                        <c:if test="${(beginPage-beginPage%10)/10+1!=group}">
                            <li><a href="${path}/category/categoryList.do?pageNow=${beginPage+10}&keywords=${pageBean.keywords}">下一页</a></li>
                            <li><a href="${path}/category/categoryList.do?pageNow=${pageBean.pageCount}&keywords=${pageBean.keywords}">尾页</a></li>
                        </c:if>
                        <li>
