...
<div id="header">
    ...
    <dl class="funcs">
        <dt>
            <form id="searchForm" name="searchForm" method="get" action="psearch.html"
                  onsubmit="return checkSearchFormAction();">
                <input class="text" name="keywords" id="so_txt" type="text" value=""
                       title="请输入商品名称或条码进行搜索" autocomplete="off" />
